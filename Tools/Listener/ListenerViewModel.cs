...
namespace krrTools.Tools.Listener
{
    ...
    public class ListenerViewModel : ReactiveViewModelBase
    {
        ...
        {
            OsuAnalysisBasic basicResult = analysisEvent.AnalysisBasic;
            OsuAnalysisPerformance? perfResult = analysisEvent.AnalysisPerformance;
            ...
            Application.Current?.Dispatcher?.Invoke(() =>
            {
                ...
                if (!string.IsNullOrEmpty(basicResult.BPMDisplay))
                {
                    ...
                    string[] bpmParts = basicResult.BPMDisplay.Split('(');
