...
namespace krrTools.Tools.KRRLNTransformer
{
    ...
    {
        private static readonly IReadOnlyDictionary<PresetKind, (string Name, KRRLNTransformerOptions Options)>
            PresetTemplates
                = new Dictionary<PresetKind, (string, KRRLNTransformerOptions)>
                {
                    ...
                    [PresetKind.NoteToOneHalfLN] = ("NoteToOneHalfLN", CreatePreset(opts =>
                                                       {
                                                           opts.LengthThreshold.Value =
                                                               KRRLNTransformerOptions.SAllIsShortLN;
                                                           opts.ShortPercentage.Value = 100;
