...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        var osuFiles = Directory.GetFiles(directoryPath, "*.osu", SearchOption.AllDirectories).Take(200).ToList();
    ...
    static async Task TestConcurrency(List<string> files, int maxConcurrency)
    {
