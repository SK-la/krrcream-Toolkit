...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            {
                Logger.WriteLine(LogLevel.Information, "[OsuMonitorService] osu!进程数: {0}, 运行: {1}", osuProcesses.Length,
                                 isOsuRunning);
                    ...
                    if (Directory.Exists(songsPath))
                    {
                            ...
                            songsPath != BaseOptionsManager.GetGlobalSettings().SongsPath.Value)
                        {
                            ...
                            Logger.WriteLine(LogLevel.Information,
                                             "[OsuMonitorService] 客户端: osu!, 进程ID: {0}, 加载Songs路径: {1}",
        ...
        public string ReadMemoryData()
        {
            ...
            try
            {
                ...
                {
                    Logger.WriteLine(LogLevel.Information, "[OsuMonitorService] 内存读取成功,用时{0}ms: beatmapFile={1}",
